...
session_start();
    ...
    array( 'db' => 'phone', 'dt' => 4 ),
    array( 'db' => 'birthday',  'dt' => 5 ),
    array( 'db' => 'email',   'dt' => 6 ),
    array( 'db' => 'major',     'dt' => 7 ),
    );

    /* Indexed column (used for fast and accurate table cardinality) */
    $sIndexColumn = "division";
    ...
    $sQuery = "SELECT nim, name, position, division, phone, birthday, email, major  FROM bom where name!='admin' ORDER BY FIELD(division,'Steering Committee','DEBATE','TOEFL','PSP','SS','QC','MF','HRD','MIT','BM','CR','PR','Alsut')";
